namespace CityTrafficSimulator.Timeline
	...
	partial class TrafficLightForm
		...
		private void InitializeComponent()
			...
			this.label4.Text = "Zeitleistenzoom (Pixel pro Sekunde):";
			// 
			// zoomSpinEdit
			// 
			...
			this.trafficLightGroupBox.Text = "LSA";
			// 
			// label3
			// 
			...
			this.label3.Text = "zugehörige Gruppe:";
			// 
			// groupComboBox
			// 
			this.groupComboBox.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.groupComboBox.FormattingEnabled = true;
			this.groupComboBox.Location = new System.Drawing.Point(112, 45);
			...
			this.label2.Text = "Name der LSA:";
			// 
			// trafficLightNameEdit
			// 
			this.trafficLightNameEdit.Location = new System.Drawing.Point(112, 19);
			this.trafficLightNameEdit.Name = "trafficLightNameEdit";
			this.trafficLightNameEdit.Size = new System.Drawing.Size(200, 20);
			...
			this.removeTrafficLightButton.Text = "LSA löschen";
			...
			this.addTrafficLightButton.Text = "neue LSA";
			...
			this.groupsGroupBox.Text = "Gruppen";
			// 
			// label1
			// 
			...
			this.removeGroupButton.Text = "Gruppe löschen";
			...
			this.addGroupButton.Text = "neue Gruppe";
